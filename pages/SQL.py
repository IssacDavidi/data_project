...
with col1:
  ...
  st.write('Praesent imperdiet turpis et risus consequat fermentum. Donec sed sollicitudin arcu. Pellentesque in neque vel justo auctor fringilla aliquet ut sapien. Fusce mauris dolor, tristique vel nulla nec, ultricies tincidunt nibh')
with col2:
